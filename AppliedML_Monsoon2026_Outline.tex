...
\begin{itemize}
  \item \href{https://personal.utdallas.edu/~herve/abdi-awPCA2010.pdf}{Abdi \& Williams, ``Principal Component Analysis'' (2010)}
\end{itemize}
...
\textit{Readings}
\begin{itemize}
  \item \href{http://networksciencebook.com}{Barabasi, \textit{Network Science} (2016), Chapters 1--3}
  \item Page, Brin et al., ``The PageRank Citation Ranking'' (1999) --- Stanford Tech Report
  \item Haldane, ``Rethinking the Financial Network'' (2009) --- Bank of England
\end{itemize}
...
\begin{itemize}
  \item Kleinberg, Lakkaraju et al., ``Human Decisions and Machine Predictions'' (2018) --- \textit{QJE}
  \item Efron \& Hastie, \textit{Computer Age Statistical Inference}, Chapter~10
\end{itemize}
...
\textit{Readings}
\begin{itemize}
  \item Varian, ``Position Auctions'' (2007) --- \textit{International Economic Review}
  \item Edelman, Ostrovsky \& Schwarz, ``Internet Advertising and the Generalized Second-Price Auction'' (2007) --- \textit{AER}
  \item \href{https://www.eff.org/wp/behind-the-one-way-mirror}{EFF, ``Behind the One-Way Mirror'' (2019)}
...
\textit{Strongly Encouraged}
\begin{itemize}
  \item \href{https://netflixtechblog.medium.com}{Netflix Technology Blog}
\end{itemize}

\textit{Background Reference}
\begin{itemize}
  \item Koren, Bell \& Volinsky, ``Matrix Factorization Techniques for Recommender Systems'' (2009) --- \textit{IEEE Computer}
  \item \href{https://arxiv.org/abs/1710.11214}{Chaney, Stewart \& Engelhardt, ``How Algorithmic Confounding Increases Homogeneity'' (2018)}
\end{itemize}
...
\textit{Strongly Encouraged}
\begin{itemize}
  \item \href{http://incompleteideas.net/IncIdeas/BitterLesson.html}{Sutton, ``The Bitter Lesson'' (2019)}
  \item \href{https://arxiv.org/abs/2001.08361}{Kaplan et al., ``Scaling Laws for Neural Language Models'' (2020)}
  \item Bubeck et al., ``Early Science Acceleration with GPT-5'' (2025)
  \item \href{https://www.youtube.com/watch?v=X_ZVSPcZhtw}{Eric Jang, ``Building AlphaGo from Scratch with Modern AI Tools'' [video]}
\end{itemize}

\textit{Background Reference}
\begin{itemize}
  \item Wigner, ``The Unreasonable Effectiveness of Mathematics in the Natural Sciences'' (1960)
  \item \href{https://arxiv.org/abs/2203.15556}{Hoffmann et al., ``Training Compute-Optimal Large Language Models'' (2022)}
  \item \href{https://darioamodei.com/machines-of-loving-grace}{Amodei, ``Machines of Loving Grace'' (2024)}
  \item \href{https://arxiv.org/abs/2007.05558}{Thompson et al., ``The Computational Limits of Deep Learning'' (2020)}
\end{itemize}
